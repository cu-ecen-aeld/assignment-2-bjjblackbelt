...
{
    const char* username_00 = my_username();
    const char* username_01 = malloc_username_from_conf_file();
    TEST_ASSERT_EQUAL_STRING_MESSAGE(username_00, username_01, "Usernames do not match.");
}
